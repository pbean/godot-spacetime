...
namespace SpacetimeDB.ScheduledTestTypes
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(JobResult = new(conn));
            AddTable(ScheduledJob = new(conn));
        }
    }
    ...
    public sealed class QueryBuilder
    {
        ...
        {
            new QueryBuilder().From.JobResult().ToSql(),
            new QueryBuilder().From.ScheduledJob().ToSql(),
        }
        ;
    }
    ...
    {
        public global::SpacetimeDB.Table<JobResult, JobResultCols, JobResultIxCols> JobResult() => new("job_result", new JobResultCols("job_result"), new JobResultIxCols("job_result"));
        public global::SpacetimeDB.Table<ScheduledJob, ScheduledJobCols, ScheduledJobIxCols> ScheduledJob() => new("scheduled_job", new ScheduledJobCols("scheduled_job"), new ScheduledJobIxCols("scheduled_job"));
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.RecordResult args => Reducers.InvokeRecordResult(eventContext, args),
