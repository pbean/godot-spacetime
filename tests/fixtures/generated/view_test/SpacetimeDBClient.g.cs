...
namespace SpacetimeDB.ViewTestTypes
{
    ...
    public sealed class From
    {
        ...
        public global::SpacetimeDB.Table<Player, PlayerOneCols, PlayerOneIxCols> PlayerOne() => new("player_one", new PlayerOneCols("player_one"), new PlayerOneIxCols("player_one"));
        public global::SpacetimeDB.Table<LevelTwoPlayerSummary, PlayersForLevelTwoCols, PlayersForLevelTwoIxCols> PlayersForLevelTwo() => new("players_for_level_two", new PlayersForLevelTwoCols("players_for_level_two"), new PlayersForLevelTwoIxCols("players_for_level_two"));
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.SeedPlayers args => Reducers.InvokeSeedPlayers(eventContext, args),
